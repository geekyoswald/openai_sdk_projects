...
# --timeout-graceful-shutdown: don't hang on Ctrl+C while a long run_sdr_pipeline is in flight
exec python -m uvicorn webhook_app:app --host "$WH" --port "$WP" --timeout-graceful-shutdown 5
